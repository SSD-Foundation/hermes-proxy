...
- Single node routes chats between two connected apps over `AppRouter.Open`, validates ed25519 signatures, enforces sequence ordering, cleans up idle chats, and persists combined chat secrets to the keystore.
